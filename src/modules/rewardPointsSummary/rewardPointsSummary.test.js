...
describe("Should render rewards component --- with success data", () => {
    ...
    test("Should render component", async () => {
        ...
        expect(screen.getAllByRole("table")[4].querySelectorAll('tr').length).toBe(2);
        expect(screen.getAllByRole("table")[4].querySelectorAll('tr')[0].querySelectorAll('th').length).toBe(3);
        expect(screen.getAllByRole("table")[4].querySelectorAll('tr')[1].querySelectorAll('td').length).toBe(3);
        //verify text content
        ...
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr').length).toBe(7);
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[0].querySelectorAll('th').length).toBe(6);
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[1].querySelectorAll('td').length).toBe(6);
        ...
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[1].querySelectorAll('td')[3]).toHaveTextContent('Watch');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[1].querySelectorAll('td')[4]).toHaveTextContent('$150');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[1].querySelectorAll('td')[5]).toHaveTextContent('150');

        // the decimal points calculation here,-.20 prcie is not calucalted, becoz its(.2*2 ) lessthan -.5
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[2].querySelectorAll('td')[3]).toHaveTextContent('Stationery');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[2].querySelectorAll('td')[4]).toHaveTextContent('$230.2');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[2].querySelectorAll('td')[5]).toHaveTextContent('310');

        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[3].querySelectorAll('td')[3]).toHaveTextContent('Toys');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[3].querySelectorAll('td')[4]).toHaveTextContent('$120');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[3].querySelectorAll('td')[5]).toHaveTextContent('90');

        //the decimal points here,-.40 prcie is calucalted, becoz its (.4*2) > -.5
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[4].querySelectorAll('td')[3]).toHaveTextContent('Toys');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[4].querySelectorAll('td')[4]).toHaveTextContent('$350.4');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[4].querySelectorAll('td')[5]).toHaveTextContent('551');

        //the price is < 100 , rewards points are (90-50) * 1, so 40 points
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[5].querySelectorAll('td')[3]).toHaveTextContent('Stationery');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[5].querySelectorAll('td')[4]).toHaveTextContent('$90');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[5].querySelectorAll('td')[5]).toHaveTextContent('40');

        //the price is < 50 , rewards points are 0
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[6].querySelectorAll('td')[3]).toHaveTextContent('Stationery');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[6].querySelectorAll('td')[4]).toHaveTextContent('$50');
        expect(screen.getAllByRole("table")[5].querySelectorAll('tr')[6].querySelectorAll('td')[5]).toHaveTextContent('0');
    ...
    test("Should render component with last 3 months rewards", async () => {
        ...
        expect(screen.getAllByRole("table")[0].querySelectorAll('tr')[0].querySelectorAll('th').length).toBe(7);
        expect(screen.getAllByRole("table")[0].querySelectorAll('tr')[1].querySelectorAll('td').length).toBe(7);
